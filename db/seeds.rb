...
Employee.create!(first_name: 'admin', last_name: 'istrator', title: 'A', email: 'admin@example.com', password: 'Password123!', password_confirmation: 'Password123!')
Employee.create!(first_name: 'jackie', last_name: 'lai', title: 'B', email: 'jack@q', password: 'Testing123$$', password_confirmation: 'Testing123$$') 
Employee.create!(first_name: '123', last_name: '321', title: '0', email: '123@123', password: 'Aa123123!!!!', password_confirmation: 'Aa123123!!!!') 

Employee.create!(first_name: 'mathieu', last_name: 'houde', title: 'engineer', email: 'mathieu.houde@codeboxx.biz', password: 'Aa123123123!', password_confirmation: 'Aa123123123!') 
Employee.create!(first_name: 'patrick', last_name: 'thibault', title: 'coach', email: 'tiboclan@gmail.com', password: 'Aa123123123!', password_confirmation: 'Aa123123123!') 
Employee.create!(first_name: 'philippe', last_name: 'motillon', title: 'coach', email: 'philippe.motillon@keyrus.ca', password: 'Aa123123123!', password_confirmation: 'Aa123123123!') 
Employee.create!(first_name: 'khalid', last_name: 'djado', title: 'coach', email: 'kdjado@gmail.com', password: 'Aa123123123!', password_confirmation: 'Aa123123123!') 
Employee.create!(first_name: 'antoine', last_name: 'deblonde', title: 'coach', email: 'antoine.deblonde@keyrus.ca', password: 'Aa123123123!', password_confirmation: 'Aa123123123!') 
Employee.create!(first_name: 'ibrahim', last_name: 'mahamane', title: 'coach', email: 'imahamaneissa@gmail.com', password: 'Aa123123123!', password_confirmation: 'Aa123123123!') 
